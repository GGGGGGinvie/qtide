...
Component that was made reactive: `,
  ...
  var _hoisted_10 = ["id", "onUpdate:modelValue", "placeholder"];
  var _hoisted_11 = ["id", "onUpdate:modelValue", "placeholder"];
  ...
  function render(_ctx, _cache) {
    return openBlock(), createElementBlock("div", _hoisted_1, [
      _cache[3] || (_cache[3] = createBaseVNode(
        ...
        { class: "header" },
        [
          createBaseVNode("h1", null, "Qtide \u8BBE\u7F6E"),
          createBaseVNode("span", { class: "badge" }, "\u529F\u80FD\u5F00\u53D1\u4E2D")
        ],
        -1
        /* CACHED */
      )),
      createBaseVNode("div", _hoisted_2, [
        createBaseVNode("div", _hoisted_3, [
          (openBlock(true), createElementBlock(
            Fragment,
            null,
            renderList(_ctx.groups, (g) => {
              return openBlock(), createElementBlock("button", {
                key: g.id,
                class: normalizeClass(["tab-btn", { active: _ctx.activeTab === g.id }]),
                onClick: ($event) => _ctx.activeTab = g.id
              }, toDisplayString(g.label), 11, _hoisted_4);
            }),
            128
            /* KEYED_FRAGMENT */
          ))
        ...
        createBaseVNode("div", _hoisted_5, [
          _ctx.groups.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_6, [..._cache[2] || (_cache[2] = [
            createBaseVNode(
              "h2",
              null,
              "\u7B49\u5F85\u914D\u7F6E...",
            ...
            renderList(_ctx.groups, (g) => {
              return withDirectives((openBlock(), createElementBlock("div", {
                ...
                (openBlock(true), createElementBlock(
                  Fragment,
                  null,
                  renderList(g.fields, (f) => {
                    return openBlock(), createElementBlock(
                      "div",
                      {
                        key: f.key,
                        class: normalizeClass(["field", { "field-checkbox": f.type === "checkbox" }])
                      },
                      [
                        f.type !== "checkbox" ? (openBlock(), createElementBlock("div", _hoisted_7, [
                          createBaseVNode("label", {
                            for: "fld_" + f.key
                          }, toDisplayString(f.label), 9, _hoisted_8),
                          f.description ? (openBlock(), createElementBlock(
                            "span",
                            _hoisted_9,
                            toDisplayString(f.description),
                            1
                            /* TEXT */
                          )) : createCommentVNode("v-if", true)
                        ])) : createCommentVNode("v-if", true),
                        f.type === "text" ? withDirectives((openBlock(), createElementBlock("input", {
                          key: 1,
                          id: "fld_" + f.key,
                          ...
                          [vModelText, _ctx.form[f.key]]
                        ]) : f.type === "textarea" ? withDirectives((openBlock(), createElementBlock("textarea", {
                          key: 2,
                          id: "fld_" + f.key,
                          "onUpdate:modelValue": ($event) => _ctx.form[f.key] = $event,
                          placeholder: f.description
                          ...
                          [vModelText, _ctx.form[f.key]]
                        ]) : f.type === "dropdown" ? withDirectives((openBlock(), createElementBlock("select", {
                          key: 3,
                          id: "fld_" + f.key,
                          "onUpdate:modelValue": ($event) => _ctx.form[f.key] = $event
                        }, [
                          ...
                          [vModelSelect, _ctx.form[f.key]]
                        ]) : f.type === "checkbox" ? (openBlock(), createElementBlock("div", _hoisted_14, [
                          withDirectives(createBaseVNode("input", {
                            id: "fld_" + f.key,
                            "onUpdate:modelValue": ($event) => _ctx.form[f.key] = $event,
                            type: "checkbox"
                          }, null, 8, _hoisted_15), [
                            [vModelCheckbox, _ctx.form[f.key]]
                          ]),
                          createBaseVNode("label", {
                            for: "fld_" + f.key
                          }, toDisplayString(f.label), 9, _hoisted_16)
                        ])) : createCommentVNode("v-if", true)
                      ],
                      2
                      /* CLASS */
      ...
      createBaseVNode("div", _hoisted_17, [
        ...
        createBaseVNode("button", {
          ...
          onClick: _cache[1] || (_cache[1] = (...args) => _ctx.onSave && _ctx.onSave(...args))
        }, "\u4FDD\u5B58")
      ])
    ]);
  }
